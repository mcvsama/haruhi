	...
	_part (part)
{
	...
	QObject::connect (_enabled_widget, SIGNAL (clicked()), this, SLOT (params_updated()));
	...
	QObject::connect (_filter_type, SIGNAL (activated (int)), this, SLOT (params_updated()));
	...
	QObject::connect (_stages, SIGNAL (valueChanged (int)), this, SLOT (params_updated()));
	...
	QObject::connect (_limiter_enabled, SIGNAL (toggled (bool)), this, SLOT (params_updated()));
