...
#ifndef HARUHI__PLUGINS__POLYTRAINER__POLYTRAINER_H__INCLUDED
#define HARUHI__PLUGINS__POLYTRAINER__POLYTRAINER_H__INCLUDED
...
class PolytrainerFactory: public Haruhi::PluginFactory
{
  public:
	Haruhi::Plugin*
	...
	const char*
	urn() const override { return  "urn://haruhi.mulabs.org/synth/polytrainer/1"; }

	const char*
	title() const override { return "Polytrainer"; }
