...
template<>
	class Atomic<unsigned int>
	{
	  ...
	  public:
		constexpr Atomic (unsigned int init = 0) noexcept: _value (init)	{ }
...
template<>
	class Atomic<int>
	{
	  ...
	  public:
		constexpr Atomic (int init = 0) noexcept: _value (init)				{ }
		Atomic (This const& other) noexcept									{ store (other.load()); }
		This& operator= (This const& other) noexcept						{ store (other.load()); return *this; }
...
template<>
	class Atomic<bool>
	{
	  ...
	  public:
		constexpr Atomic (bool init = false) noexcept: _value (init)		{ }
		Atomic (This const& other) noexcept									{ store (other.load()); }
		This& operator= (This const& other) noexcept						{ store (other.load()); return *this; }
...
template<>
	class Atomic<float>
	{
	  ...
	  public:
		constexpr Atomic (float init = false) noexcept: _value (init)		{ }
		Atomic (This const& other) noexcept									{ store (other.load()); }
		This& operator= (This const& other) noexcept						{ store (other.load()); return *this; }
...
template<class Type>
	class Atomic<Type*>
	{
	  ...
	  public:
		constexpr Atomic (Type* init = 0) noexcept: _value (init)			{ }
		Atomic (This const& other) noexcept									{ store (other.load()); }
		This& operator= (This const& other) noexcept						{ store (other.load()); return *this; }
