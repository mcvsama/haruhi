...
class Unit: private Noncopyable
{
  ...
  public:
	 ...
	 */
	static bool
	compare_by_title (Unit const* first, Unit const* second) noexcept;
...
inline bool
Unit::compare_by_title (Unit const* first, Unit const* second) noexcept
{
