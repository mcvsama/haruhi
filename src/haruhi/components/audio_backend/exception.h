...
#ifndef HARUHI__COMPONENTS__AUDIO_BACKEND__EXCEPTION_H__INCLUDED
#define HARUHI__COMPONENTS__AUDIO_BACKEND__EXCEPTION_H__INCLUDED
...
class ConnectException: public Exception
{
  public:
	explicit
	ConnectException (const char* what, const char* details):
		Exception (what, details)
	{ }
};
