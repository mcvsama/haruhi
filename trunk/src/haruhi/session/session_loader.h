...
#ifndef HARUHI__SESSION_LOADER_H__INCLUDED
#define HARUHI__SESSION_LOADER_H__INCLUDED
...
class SessionLoader: public QDialog
{
	...
	{
	  public:
		RecentSessionItem (QTreeWidget* parent, Config::RecentSession const& recent_session):
	  ...
	  public:
		Config::RecentSession recent_session;
	};
